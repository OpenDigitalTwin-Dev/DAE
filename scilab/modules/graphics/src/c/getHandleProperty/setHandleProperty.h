...
int set_interpreter_property(void* _pvCtx, int iObj, void* _pvData, int valueType, int nbRow, int nbCol);
...
int set_tics_interpreters_property(void* _pvCtx, int iObj, void* _pvData, int valueType, int nbRow, int nbCol);
